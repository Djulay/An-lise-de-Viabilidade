        ...
        <div class="flex-1 p-6 md:ml-64">
            ...
            <div class="max-w-6xl mx-auto p-6 mt-10 bg-white rounded-lg shadow-md">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-2xl font-bold text-gray-800">Todos os Usuários Cadastrados</h1>
                    ...
                    <table class="min-w-full bg-white border rounded-lg">
                        <thead class="bg-gray-100 text-gray-700 text-sm uppercase">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left">Província</th>
                        ...
                        <tbody class="text-gray-800 text-sm divide-y divide-gray-200">
                            @forelse ($usuarios as $usuario)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4">{{ $usuario->provincia ?? 'N/D' }}</td>
                                    <td class="px-6 py-4">{{ $usuario->role ?? 'usuário' }}</td>
                                    <td class="px-6 py-4 text-center">
                                        <div class="flex gap-2 justify-center">
                                            ...
                                            <div x-data="{ showModal_{{ $usuario->id }}: false }">
                                                <button @click="showModal_{{ $usuario->id }} = true"
                                                    class="bg-red-500 text-white px-3 py-1 rounded hover:bg-red-600 text-xs">
                                                    Apagar
                                                </button>

                                                <!-- Modal -->
                                                <div x-show="showModal_{{ $usuario->id }}" x-transition.opacity
                                                    class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                                                    <div @click.away="showModal_{{ $usuario->id }} = false"
                                                        class="bg-white p-6 rounded-lg shadow-xl w-full max-w-sm text-center space-y-4">
                                                        <h2 class="text-lg font-semibold text-gray-800">Deseja mesmo
                                                            apagar?</h2>
                                                        ...
                                                        <div class="flex justify-center gap-4 mt-4">
                                                            ...
                                                            <button @click="showModal_{{ $usuario->id }} = false"
