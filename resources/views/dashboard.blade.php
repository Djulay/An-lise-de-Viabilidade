    ...
    <div class="flex h-screen">
        ...
        <div class="flex-1 p-6 md:ml-64">
                            ...
                            <ul class="py-2">
                                ...
                                <li>
                                    <form method="POST" action="{{ route('logout') }}">
                                        @csrf
                                        <button type="submit" class="block w-full text-left px-4 py-2 hover:bg-red-500 text-red-700">Sair</button>
                                    </form>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="bg-white p-4 shadow rounded">
                    <h2 class="text-lg font-semibold">Vendas Mensais</h2>
                    <p class="text-2xl font-bold">$45,000</p>
                </div>
                <div class="bg-white p-4 shadow rounded">
                    <h2 class="text-lg font-semibold">Novos Registros</h2>
