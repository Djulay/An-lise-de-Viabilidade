    ...
    <div class="flex h-screen">
                    ...
                    <li class="mb-4">
                        ...
                        <ul id="viabilityMenu" class="hidden ml-4">
                           <li><a href="{{ route("analises.create") }}" class="block py-2 px-4 hover:bg-blue-600 rounded">Criar</a></li>
                            <li><a href="{{ route("analises.index")}}" class="block py-2 px-4 hover:bg-blue-600 rounded">Visualizar</a></li>
                        </ul>
                    </li>
                </ul>
            </nav>
        ...
        <div class="flex-1 p-6 md:ml-64">
            ...
            <div class="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md mt-10">
                ...
                <form action="{{ route('analises.store') }}" method="POST" class="space-y-4">
                    @csrf
                    ...
                    <div class="pt-4">
                        <button type="#"  //submit  para enviar para o formulário étá desafivado de momento
