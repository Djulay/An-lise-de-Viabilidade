        ...
        <div class="flex-1 p-6 md:ml-64">
            ...
            <div class="max-w-6xl mx-auto p-6 mt-10 bg-white rounded-lg shadow-md">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-2xl font-bold text-gray-800">Minhas Análises</h1>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full bg-white border rounded-lg">
                        <thead class="bg-gray-100 text-gray-700 text-sm uppercase">
                            <tr>
                                <th class="px-6 py-3 text-left">Nome da Ideia</th>
                                <th class="px-6 py-3 text-left">Tipo</th>
                                <th class="px-6 py-3 text-left">Capital Inicial</th>
                        ...
                        <tbody class="text-gray-800 text-sm divide-y divide-gray-200">
                            @forelse ($analises as $analise)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4">AKZ
                                        {{ number_format($analise->capital_inicial, 2, ',', '.') }}
                                    </td>
                                                ...
                                                <div x-show="showModal" x-transition.opacity
                                                    ...
                                                    <div @click.away="showModal = false"
                                                        ...
                                                        <div class="flex justify-center gap-4 mt-4">
                                                            <form action="{{ route('analises.destroy', $analise->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="submit"
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="px-6 py-4 text-center text-gray-500">Nenhuma análise
                                        encontrada.</td>
                                </tr>
                            @endforelse
                        </tbody>
